...
module.exports.run = async(client, message, args) => {
    ...
    let embed = new MessageEmbed().setColor(config.Colors.Black).setAuthor(message.guild.name, message.guild.iconURL({dynamic:true}));
    ...
    await member.roles.add(config.Roles.Erkek);
