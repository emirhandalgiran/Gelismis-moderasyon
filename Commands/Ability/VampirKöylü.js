...
module.exports.run = async(client, message, args) => {
    ...
    if(!message.member.roles.cache.has(config.AblitiyAdmin.VKAdmin) && !message.member.hasPermission(("ADMINISTRTOR"))) {return};
    ...
    let role = config.Ability.VKYönetici; if(!role) {return};
