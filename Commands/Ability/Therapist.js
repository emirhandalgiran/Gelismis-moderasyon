...
module.exports.run = async(client, message, args) => {
    ...
    if(!message.member.roles.cache.has(config.AblitiyAdmin.TherapistAdmin) && !message.member.hasPermission(("ADMINISTRTOR"))) {return};
    ...
    let role = config.Ability.Therapist; if(!role) {return};
...
exports.help = { name: "therapist"};

exports.conf = { aliases: ["therapist", "terapist"]};