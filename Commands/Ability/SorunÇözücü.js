...
module.exports.run = async(client, message, args) => {
    ...
    if(!message.member.roles.cache.has(config.AblitiyAdmin.SorunÇözücüAdmin) && !message.member.hasPermission(("ADMINISTRTOR"))) {return};
    ...
    let role = config.Ability.SorunÇözücü; if(!role) {return};
...
exports.conf = { aliases: ["instagrammer", "instagram"]};