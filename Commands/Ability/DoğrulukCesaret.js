...
module.exports.run = async(client, message, args) => {
    ...
    if(!message.member.roles.cache.has(config.AblitiyAdmin.DCAdmin) && !message.member.hasPermission(("ADMINISTRTOR"))) {return};
    ...
    let role = config.Ability.DCYönetici; if(!role) {return};
